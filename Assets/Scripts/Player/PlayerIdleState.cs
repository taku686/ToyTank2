...
public partial class PlayerCore
{
    public class PlayerIdleState : State
    {
        ...
        {
            _baseMove.Move(_userData.baseData.MoveSpeed);
        ...
        private void OnDragUltimatejoystick()
        {
            ...
            {
                Owner._Ishot.Shot(Owner._shellManager.GetShell(_shellPoolTag,_userData.currentCanonIndex),Owner._currentCanon);
            }
