...
namespace BehaviorDesigner.Runtime.Tasks.Movement
{
    ...
    public class Search : NavMeshMovement
    {
        ...
        [Tooltip("The object that is found")] public SharedGameObject returnedObject;
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            if (senseAudio.Value)
            {
                returnedObject.Value = MovementUtility.WithinHearingRange(transform, offset.Value,
                    audibilityThreshold.Value, hearingRadius.Value, overlapColliders, objectLayerMask);
        ...
        private bool TrySetTarget()
        {
            ...
            while (!validDestination && attempts > 0)
            {
                ...
                destination = transform.position +
                              direction.normalized * Random.Range(minWanderDistance.Value, maxWanderDistance.Value);
